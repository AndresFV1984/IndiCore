...
export const USER_PERMISSION_CATALOG = [
  ...
  { id: 'production.status.view', label: 'Ver estado de órdenes de producción' },
  { id: 'production.status.supervise', label: 'Gestionar estado global de producción' },
  { id: 'production.status.phase', label: 'Marcar etapas de producción en proceso' },
  { id: 'production.status.phase.preprensa', label: 'Marcar preprensa en proceso' },
  { id: 'production.status.phase.corte-papel', label: 'Marcar corte de papel en proceso' },
...
export const ROLE_PERMISSIONS: Record<UserRole, readonly UserPermission[]> = {
  ...
  Supervisor: [
    ...
    'production.status.supervise',
    'production.status.phase',
    'production.status.phase.preprensa',
    'production.status.phase.corte-papel',
