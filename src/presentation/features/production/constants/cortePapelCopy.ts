export const CORTE_PAPEL_COPY = {
  ...
  registroPreprensa: {
    ...
    subtitle: 'Seleccione la plancha para configurar el corte de papel.',
    label: 'Plancha',
    placeholder: 'Seleccione un registro de preprensa…',
    hint: 'Un registro de corte por plancha. Las planchas completadas se marcan en el listado.',
  ...
  sections: {
    ...
    datosPlancha: {
      zoneLabel: 'Datos de corte papel',
      sectionHint: 'Tamaños buenos y sobrante usados para calcular la cantidad de hojas.',
      tamanosBuenosLabel: 'Tamaños buenos',
      tamanosBuenosHint: 'Del registro de Preprensa o cantidades ingresadas para este corte.',
      tamanosBuenosFormula: 'Cantidad ÷ Cavidades (redondeo al entero más cercano)',
      tamanosBuenosEmpty: '—',
      sobranteLabel: 'Sobrante',
      sobranteHint: 'Del registro de Preprensa o cantidades ingresadas para este corte.',
      sobranteEmpty: '—',
      formulaSummary: 'Ver fórmula de cálculo',
      sourceBadgePreprensa: 'Preprensa',
      sourceBadgeManualCliente: 'Cliente',
      sourceBadgeFaltante: 'Faltante',
      sourceBadgeManualFaltante: 'Litografía',
      sourcePreprensa:
        'Valores del registro de Preprensa seleccionado.',
      sourceManualCliente: 'Cantidades ingresadas en Estado del papel para este registro.',
      sourceFaltanteHojas:
        'Hojas faltantes calculadas al comparar lo entregado por el cliente con lo requerido.',
      sourceManualFaltante:
        'Cantidades ingresadas para el material que suministra litografía por el faltante.',
      formulaTamanosBuenos: (cantidad: string, cavidades: string, resultado: string) =>
        `Cantidad ${cantidad} ÷ ${cavidades} cavidades = ${resultado}`,
      emptyPreprensa: 'Complete cantidad y cavidades en Preprensa para este registro.',
      emptyManual: 'Ingrese tamaños buenos y sobrante en Estado del papel.',
      emptyFaltante: 'Aún no hay hojas faltantes calculadas para este registro.',
      notApplicable: '—',
    },
    valores: {
  ...
  registros: {
    ...
    pasoRegistros: 'Registros de corte confirmados',
  ...
  resumen: {
    ...
    subtitleCompacto: (completados: number, total: number) =>
      `${completados} de ${total} listo${total === 1 ? '' : 's'} · Clic en un registro para editarlo`,
    subtitleConsolidado: 'Totales de valor papel y valor corte de todos los registros',
    ...
    total: 'Total',
    totalHint: 'Suma de valor papel y valor corte de este registro',
    totalHintConsolidado: 'Suma de valor papel y valor corte de todos los registros',
    totalCantidadHojas: 'Total cantidad hojas',
    totalValorPapel: 'Valor papel',
