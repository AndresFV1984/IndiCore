...
import {
  formatEntradaAcabadosResumen,
  resolveEntradaAcabadosTotal,
  type AcabadosAsignadosRow,
...
interface AcabadosRegistrosListProps {
  rows: AcabadosAsignadosRow[]
...
const AcabadosRegistrosList: React.FC<AcabadosRegistrosListProps> = ({
  rows,
  activeCorteRowKey,
  editingEntradaId,
  onEdit,
  ...
  <div className="production-acabados-registros-list">
    <div className="production-plancha-table-wrap">
      <table className="production-plancha-table production-acabados-registros-list__table">
        <thead>
          <tr>
            ...
            <th className="production-plancha-table__th production-plancha-table__th--desc">
              {registrosCopy.columns.acabados}
            </th>
          ...
          {rows.length === 0 ? (
            <tr className="production-plancha-table__row production-plancha-table__row--empty">
              <td className="production-plancha-table__td" colSpan={TABLE_COL_COUNT}>
                <div className="production-acabados-registros-list__empty">
            ...
            rows.map(({ corteRowKey, planchaLabel, entrada }) => {
              ...
              const entradaTotal = resolveEntradaAcabadosTotal(entrada)
              const acabadosResumen = formatEntradaAcabadosResumen(entrada)
              ...
              return (
                <tr
                  ...
                  className={clsx(
                    ...
                    isEditing && 'production-acabados-registros-list__row--editing'
                  )}
                >
                  <td
                    className="production-plancha-table__td production-acabados-registros-list__plancha"
                    title={planchaLabel}
                  >
                    <span className="production-plancha-table__truncate">{planchaLabel}</span>
                  </td>
                  <td
                    className="production-plancha-table__td production-acabados-registros-list__acabados"
                    title={acabadosResumen}
                  >
                    <span className="production-acabados-registros-list__acabados-text">
                      {acabadosResumen}
                    </span>
                  </td>
                  <td className="production-plancha-table__td production-plancha-table__td--num production-plancha-table__td--total">
                    <strong className="production-acabados-registros-list__total">
...
export default AcabadosRegistrosList
