...
interface AcabadosPlanchaDetalleFieldsProps {
  context: AcabadosCorteContext
}

const AcabadosPlanchaDetalleFields: React.FC<AcabadosPlanchaDetalleFieldsProps> = ({
  context,
}) => {
...
export default AcabadosPlanchaDetalleFields
