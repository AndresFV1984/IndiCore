...
import type { AcabadosCorteContext } from './utils/acabadosUtils'
import { resolveAcabadosContextPlancha } from './utils/acabadosUtils'
...
const PlanchaSelectRow: React.FC<{
  ...
  const plancha = resolveAcabadosContextPlancha(context, coloresPlanchas)
...
interface AcabadosPlanchaSelectProps {
  id: string
  labelId: string
...
const AcabadosPlanchaSelect: React.FC<AcabadosPlanchaSelectProps> = ({
  id,
  labelId,
  contexts,
  coloresPlanchas,
...
export default AcabadosPlanchaSelect
